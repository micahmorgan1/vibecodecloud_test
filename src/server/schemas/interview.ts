...
export const interviewCreateSchema = z.object({
  ...
  notesUrl: z.string().trim().max(2000).transform(stripHtml).optional().nullable().or(z.literal('')),
...
export const interviewUpdateSchema = z.object({
  ...
  notesUrl: z.string().trim().max(2000).transform(stripHtml).optional().nullable(),
